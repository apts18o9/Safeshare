...
var initCleanupService = function () {
    node_cron_1.default.schedule('0 * * * *', function () { return __awaiter(void 0, void 0, void 0, function () {
        var now, twoHoursAgo, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('Running scheduled cleanup job for transfers...');
                    now = new Date();
                    twoHoursAgo = new Date(now.getTime() - (2 * 60 * 60 * 1000)) //2 hrs in milliseconds
                    ;
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, Transfer_1.default.deleteMany({
                            $or: [
                ...
                case 2:
                    result = _a.sent();
                    console.log("Cleanup Job finished. Deleted ".concat(result.deletedCount, " old transfers"));
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
                    console.error("Error during cleanup job: ".concat(error_1.message));
                    return [3 /*break*/, 4];
...
exports.default = initCleanupService;
